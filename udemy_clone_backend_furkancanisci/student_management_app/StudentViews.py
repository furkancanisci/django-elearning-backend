...
from .models import CustomUser, Staffs, Courses, Subjects, Students, Attendance, AttendanceReport, LeaveReportStudent, FeedBackStudent, StudentResult, Lesson
...
def student_view_lesson_post(request):
    if request.method != "POST":
        ...
        return render(request, 'student_template/student_lesson_data.html', context)
...
def student_view_attendance_post(request):
    if request.method != "POST":
        ...
        subject_obj = Subjects.objects.get(id=subject_id)          #dersin kendisi
        user_obj = CustomUser.objects.get(id=request.user.id)
        stud_obj = Students.objects.get(admin=user_obj)  #ogrenci datası
