...
from . import views
from .import DepViews, StaffViews, StudentViews
...
urlpatterns = [
    ...
    path('add_subject_save/', DepViews.add_subject_save, name="add_subject_save"),
    path('manage_subject/', DepViews.manage_subject, name="manage_subject"),
    path('edit_subject/<subject_id>/', DepViews.edit_subject, name="edit_subject"),
    path('edit_subject_save/', DepViews.edit_subject_save, name="edit_subject_save"),
    path('delete_subject/<subject_id>/', DepViews.delete_subject, name="delete_subject"),
    path('check_email_exist/', DepViews.check_email_exist, name="check_email_exist"),
    path('check_username_exist/', DepViews.check_username_exist, name="check_username_exist"),
    path('student_feedback_message/', DepViews.student_feedback_message, name="student_feedback_message"),
    path('student_feedback_message_reply/', DepViews.student_feedback_message_reply, name="student_feedback_message_reply"),
    path('staff_feedback_message/', DepViews.staff_feedback_message, name="staff_feedback_message"),
    path('staff_feedback_message_reply/', DepViews.staff_feedback_message_reply, name="staff_feedback_message_reply"),
    path('student_leave_view/', DepViews.student_leave_view, name="student_leave_view"),
    path('student_leave_approve/<leave_id>/', DepViews.student_leave_approve, name="student_leave_approve"),
    path('student_leave_reject/<leave_id>/', DepViews.student_leave_reject, name="student_leave_reject"),
    path('staff_leave_view/', DepViews.staff_leave_view, name="staff_leave_view"),
    path('staff_leave_approve/<leave_id>/', DepViews.staff_leave_approve, name="staff_leave_approve"),
    path('staff_leave_reject/<leave_id>/', DepViews.staff_leave_reject, name="staff_leave_reject"),
    path('admin_view_attendance/', DepViews.admin_view_attendance, name="admin_view_attendance"),
    path('admin_get_attendance_dates/', DepViews.admin_get_attendance_dates, name="admin_get_attendance_dates"),
    path('admin_get_attendance_student/', DepViews.admin_get_attendance_student, name="admin_get_attendance_student"),
    path('admin_profile/', DepViews.admin_profile, name="admin_profile"),
    path('admin_profile_update/', DepViews.admin_profile_update, name="admin_profile_update"),
